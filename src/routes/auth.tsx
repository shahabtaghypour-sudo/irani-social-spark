...
function AuthPage() {
  ...
  return (
    <div className="gradient-hero flex flex-1 items-center justify-center px-4 py-12">
      <div className="card-soft w-full max-w-md rounded-3xl p-8 shadow-soft">
        <div className="text-center">
          <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-lavender-400 to-rose-400 text-primary-foreground">
        ...
        <form onSubmit={handleEmailAuth} className="mt-8 space-y-4">
          ...
          {message && <p className="text-sm text-lavender-600">{message}</p>}
